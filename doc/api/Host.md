...
files. The host's API endpoints expose methods for viewing and changing the
current host settings (e.g. price), and manually announcing to the network.
...
| ----------------------------------------------------- | --------- | ------------------------------------------------- |
| [/host](#host-get-example)                            | GET       | [Host info](#host-info)                           |
| [/host](#host-post-example)                           | POST      | [Modify price](#modify-price)                     |
| [/host/announce](#host-announce-example)              | POST      | [Announce](#announce)                             |
| [/host/delete/{filecontractid}](#host-delete-example) | POST      | [Handling DMCA requests](#handling-dmca-requests) |

#### /host [GET] [(example)](#host-info)
