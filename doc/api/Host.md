...
files. The host's API endpoints expose methods for viewing and modifying host
settings, e.g. price, and for managing where the host stores files.
...
```javascript
{
    ...
    "externalsettings": {
        ...
        "maxdownloadbatchsize": Number, // uint64
        ...
        "maxduration": Number, // types.BlockHeight (uint64)
        ...
        "windowsize": Number, // types.BlockHeight (uint64)
    ...
    "financialmetrics": {
        ...
        //
        // The unit is hastings.
        "contractcompensation": String, // types.Currency (string)
        ...
        //
        // The unit is hastings.
        "potentialcontractcompensation": String, // types.Currency (string)
        ...
        //
        // The unit is hastings.
        "lockedstoragecollateral": String, // types.Currency (string)
        ...
        //
        // The unit is hastings.
        "lostrevenue": String, // types.Currency (string)
        ...
        //
        // The unit is hastings.
        "riskedstoragecollateral": String, // types.Currency (string)
        ...
        //
        // The unit is hastings.
        "storagerevenue": String, // types.Currency (string)
        ...
        //
        // The unit is hastings.
        "transactionfeeexpenses": String, // types.Currency (string)
        ...
        //
        // The unit is hastings.
        "downloadbandwidthrevenue": String, // types.Currency (string)
        ...
        //
        // The unit is hastings.
        "potentialdownloadbandwidthrevenue": String, // types.Currency (string)
        ...
        //
        // The unit is hastings.
        "potentialuploadbandwidthrevenue": String, // types.Currency (string)
        ...
        // proofs.
        "uploadbandwidthrevenue": String, // types.Currency (string)
    }
    ...
    "internalsettings": {
        ...
        //
        // The unit is hastings.
        "collateralbudget": String, // types.Currency (string)
        ...
        //
        // The unit is hastings.
        "mincontractprice": String, // types.Currency (string)
        ...
        //
        // The unit is hastings per byte.
        "mindownloadbandwidthprice": String, // types.Currency (string)
        ...
        //
        // The unit is hastings per byte per block.
        "minstorageprice": String, // types.Currency (string)
        ...
        //
        // The unit is hastings per byte.
        "minuploadbandwidthprice": String, // types.Currency (string)
    }
    ...
    networkmetrics {
        ...
        "unrecognizedcalls": Number, // uint64
    }
}
```
